...
public class Utilies {
    ...
    public static String getLeague(int league_num) {
        switch (league_num) {
            ...
            case PRIMERA_DIVISION:
                return context.getString(R.string.league_primeradivision);
            case BUNDESLIGA:
                return context.getString(R.string.league_bundesliga);
            default:
                return context.getString(R.string.league_unknow);
        }
    }
    ...
    public static String getMatchDay(int match_day, int league_num) {
        if (league_num == CHAMPIONS_LEAGUE) {
            if (match_day <= 6) {
                return context.getString(R.string.matchday_group);
            } else if (match_day == 7 || match_day == 8) {
                return context.getString(R.string.matchday_first_knockout);
            } else if (match_day == 9 || match_day == 10) {
                return context.getString(R.string.matchday_quarter);
            ...
            return context.getString(R.string.matchday_defaultvalue) + String.valueOf(match_day);
        }
    }
